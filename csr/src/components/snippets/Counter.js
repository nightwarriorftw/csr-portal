...
export default class Counter extends PureComponent {
    ...
    componentDidMount() {
        ...
        let updater = () => {
            if (c1 < 20) {
                c1++;
                document.getElementById('companies').innerHTML = c1.toString() + ` <span> Total Companies<br>Registered</span>`;
            }
            if (c2 < 10) {
                c2++;
                document.getElementById('events').innerHTML = c2.toString() + ` <span> Total Events<br>Hosted</span>`;
            }
        }
    }
                        ...
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <div className="countdown" id="counter">
                                    <div id="companies">00 <span>Total Companies</span></div>
                                    <div id="events">00 <span>Total Events</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
